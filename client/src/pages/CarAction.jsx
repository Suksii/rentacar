...
const CarAction = () => {
    ...
    return (
        <div className="h-full w-full py-10" style={{backgroundImage: `url(${carBg})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
            <div className="bg-gray-200 w-[60%] mx-auto p-5 rounded-md shadow-md bg-opacity-80">
